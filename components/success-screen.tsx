    ...
    >
      ...
      <div className='relative mb-6' style={{ perspective: "1000px" }}>
        ...
        >
          ...
          {/* Back of the card */}
          <div
            className='absolute inset-0 flex flex-col items-center justify-center bg-gray-800 text-white rounded-lg p-5 backface-hidden'
            style={{
          ...
          >
            ...
            <p className='text-center text-sm'>Made for Gomry and Silver.dev</p>
          </div>
        </div>
      </div>
