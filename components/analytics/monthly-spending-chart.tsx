...
const generateData = (timeRange: string, showComparison = false) => {
  ...
  for (let i = months - 1; i >= 0; i--) {
    ...
    const total = groceries + dining + shopping + entertainment + transportation + other
...
export function MonthlySpendingChart({ timeRange, showComparison = false }: MonthlySpendingChartProps) {
