  ...
  return [
    {
      ...
      previousAmount: 320 + Math.random() * 100,
    },
    {
      name: "Tuesday",
      amount: 300 + Math.random() * 100,
      previousAmount: 280 + Math.random() * 100,
    },
    {
      name: "Wednesday",
      amount: 400 + Math.random() * 100,
      previousAmount: 370 + Math.random() * 100,
    },
    {
      name: "Thursday",
      amount: 450 + Math.random() * 100,
      previousAmount: 420 + Math.random() * 100,
    },
    {
      name: "Friday",
      amount: 600 + Math.random() * 150,
      previousAmount: 550 + Math.random() * 150,
    },
    {
      name: "Saturday",
      amount: 750 + Math.random() * 200,
      previousAmount: 700 + Math.random() * 200,
    },
    {
      name: "Sunday",
      amount: 550 + Math.random() * 150,
      previousAmount: 500 + Math.random() * 150,
    },
  ];
};
